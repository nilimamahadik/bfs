...
const ConsigneeMaster = () => {
    ...
    const handleUpload = async () => {
        ...
        Papa.parse(file.originFileObj, {
            complete: async (result) => {
                ...
                try {
                    const response = await axios.post(`${BASEURL}/uploadconsignee`, { products: records });
    ...
    const columns = [
        ...
        { field: "name", headerName: "Name of Consignee", minWidth: 150, flex: 1 },
